...
export default function AboutPage() {
  ...
  useEffect(() => {
    ...
    document.title = 'من نحن | معرض وحدة اليمن للسيارات';
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground whitespace-pre-line leading-relaxed">
                  {settings?.description || 'نحن معرض متخصص في بيع السيارات الجديدة والمستعملة بأفضل الأسعار وأعلى جودة. نسعى دائماً لتقديم أفضل الخدمات لعملائنا الكرام.'}
                </p>
              </CardContent>
            </Card>
                ...
                <address className="space-y-4 not-italic">
                  {settings?.address && (
                    <div className="flex items-start gap-3">
                      <MapPinIcon className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" aria-hidden="true" />
                      <div>
                  ...
                  {settings?.phone && (
                    <div className="flex items-start gap-3">
                      <PhoneIcon className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" aria-hidden="true" />
                      <div>
                  ...
                  {settings?.whatsapp && (
                    <div className="flex items-start gap-3">
                      <WhatsAppIcon className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" aria-hidden="true" />
                      <div>
                  ...
                  {settings?.workingHours && (
                    <div className="flex items-start gap-3">
                      <ClockIcon className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" aria-hidden="true" />
                      <div>
          ...
          <section className="space-y-6" aria-labelledby="location-heading">
            <Card className="overflow-hidden">
              <CardContent className="p-0">
                <h2 id="location-heading" className="sr-only">موقعنا على الخريطة</h2>
...
function CarIcon({ className }: { className?: string }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 17h8M8 17v-4m8 4v-4m-8 0h8m-8 0l-2-4h12l-2 4M6 17H4a1 1 0 01-1-1v-2a1 1 0 011-1h2m14 4h2a1 1 0 001-1v-2a1 1 0 00-1-1h-2" />
    </svg>
  );
}
